...
### draft script, to be finalised when python script of creating plot is completed
...
## Copy bperp files to central directory
...
# Move unw files to Pyrate directory
pyrate_dir=$proj_dir/$track_dir/pyrate_files/unw_files
while read unw; do
    mv $unw $pyrate_dir
done < unw_list
mv unw_list ifg.rsc $pyrate_dir
