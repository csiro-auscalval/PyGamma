...
OFFSET_PWR_OVERSAMPLING_FACTOR = 2

BASE_LS_DERIVE_FROM_ORBIT = 0
BASE_LS_ESTIMATE_FROM_DATA = 1
...
RASCC_MIN_THINNING_THRESHOLD = 1
RASCC_THINNING_THRESHOLD = 4
RASCC_THRESHOLD_INCREMENT = 0.2
...
CPX_TO_REAL_OUTPUT_TYPE_PHASE = 4
