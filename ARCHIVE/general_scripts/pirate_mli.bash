...
mli_eqa=r$mas_date"_"$polar"_"$lks"rlks_eqa.mli"
mli_eqa2=r$mas_date"_"$polar"_"$lks"rlks_eqa.mli2"

diff_dem=/g/data1/dg9/INSAR_ANALYSIS/$project/$sensor/GAMMA/$track/DEM/"diff_"$mas_date"_"$polar"_"$lks"rlks.par"
dem_par=/g/data1/dg9/INSAR_ANALYSIS/$project/$sensor/GAMMA/$track/DEM/$mas_date"_"$polar"_"$lks"rlks_eqa.dem.par"
gc_map=/g/data1/dg9/INSAR_ANALYSIS/$project/$sensor/GAMMA/$track/DEM/$mas_date"_"$polar"_"$lks"rlks_fine_eqa_to_rdc.lt"
...
#view mli
#dispwr $mli_eqa $width_out 1 0 1 0.35 0

# replace nan (0) with 9999
replace_values $mli_eqa 0 9999 $mli_eqa2 $width_out 0 2
