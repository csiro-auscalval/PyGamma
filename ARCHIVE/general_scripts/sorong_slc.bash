...
mli_eqa=$date"_eqa.mli"
mli_txt=$date"_mli.txt"
psfile=$date"_mli.ps"

diff_dem=/g/data1/dg9/INSAR_ANALYSIS/SORONG/PALSAR1/GAMMA/T387A/DEM/diff_20081014_HH_4rlks.par
dem_par=/g/data1/dg9/INSAR_ANALYSIS/SORONG/PALSAR1/GAMMA/T387A/DEM/20081014_HH_4rlks_eqa.dem.par
gc_map=/g/data1/dg9/INSAR_ANALYSIS/SORONG/PALSAR1/GAMMA/T387A/DEM/20081014_HH_4rlks_fine_eqa_to_rdc.lt

width_in=`grep range_samp_1: $diff_dem | awk '{print $2}'`
width_out=`grep width: $dem_par | awk '{print $2}'`

geocode_back $mli $width_in $gc_map $mli_eqa $width_out - 1 0 - -
...
float2ascii $mli_eqa 1 $mli_txt 0 -
