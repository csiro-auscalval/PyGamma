...
display_usage() {
    echo ""
    echo "*******************************************************************************"
    echo "* process_PALSAR1_SLC:  Script takes Level 1.0 (raw) PALSAR1 fine beam data   *"
    echo "*                       and produces sigma0 calibrated SLC and and Multi-look *"
    ...
    echo "*******************************************************************************"
    echo -e "Usage: process_PALSAR1_SLC.bash [proc_file] [scene] [rlks] [alks]"
    }
