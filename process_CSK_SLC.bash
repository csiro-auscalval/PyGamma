...
display_usage() {
    ...
    echo "*                   (MLI) images in GAMMA format.                             *"
    echo "*                                                                             *"
    ...
    echo "*******************************************************************************"
    echo -e "Usage: process_CSK_SLC.bash [proc_file] [scene] [rlks] [alks]"
    }
...
## corner coordinates given in SLC MSP parameter file     ####### MSP FILE NOT PRODUCED FOR CSK ######
